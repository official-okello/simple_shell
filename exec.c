...
/**
  * concat_path - Concatenates  path and program name
  * @pathname: path name
  * @progname: program name
  *
  * Return: path name +  program name
  */
...
/**
  * find - check for a command in the system
  * @cname: command name
  *
  * Return: path name of command or NULL
  */
